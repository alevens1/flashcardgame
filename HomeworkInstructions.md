...
// This should have three files. one file for basiccard.js, one file for cloze.js, 
//and the last file for main.js
//basic.js should only have a constructor and a module.export = basiccard.js statement
//cloze.js should only have a constructor and a module.export = cloze.js statement. 
//must have something like function cloze(full, cloze){
//	this.full = full;
//	this.partial = ?
//}

//var x = new Cloze("Scott is awesome", Scott);
//x= {
//	full: "Scott is awesome";
//	cloze: "Scott";
//	partial: "...is awesome";
//}


///the main.js file is where we import the constructors. We use require statement for basicard.js
//and cloze.js. create a basic card object using constructor from basic.js and then console log it
//create a cloze object using contrcutor from cloze.js and then console lg it


///eg for cloze.js:::
///var x = new Cloze ("George Washington was first president.", "GW")
///var b = new Basic ("Who was first president?", "GW");
//
